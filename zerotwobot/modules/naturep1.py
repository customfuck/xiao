...
RATICATE_HANDLER = DisableAbleCommandHandler(("raticate", "rattata", "sharpedo", "rayquaza"), raticate, run_async=True)
...
SLOWBRO_HANDLER = DisableAbleCommandHandler(("slowbro", "slowpoke", "kyogre", "latios", ), slowbro, run_async=True)
...
HYPNO_HANDLER = DisableAbleCommandHandler(("hypno", "drowzee", "zapdos", "moltres", "jirachi", "dialga", "wigglytuff", "clefable", "venomoth", "golduck", "magneton", "jigglypuff", "clefairy", "venonat", "psyduck", "magnemite"), hypno, run_async=True)
KINGLER_HANDLER = DisableAbleCommandHandler(("kingler", "krabby", "lugia", "mamoswine", "guzzlord", "sandslash", "sandshrew", "nidoqueen", "nidorina", "dugtrio", "diglett", "primeape", "mankey", "poliwrath", "poliwhirl", "poliwag", "machamp", "machoke", "machop", "farfetchd", "onix"), kingler, run_async=True)
